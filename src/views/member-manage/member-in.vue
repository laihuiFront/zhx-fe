  ...
  <div id="member-in">
    <div class="left-wrap">
      <el-tree
        ...
        class="tree-wrap"
        width="400px">
        <span :class="{active:queryForm.department === data.id}" class="custom-tree-node" slot-scope="{ node, data }">
          {{data.orgName}}
        </span>
      </el-tree>
    </div>
    ...
    <el-dialog
      ...
      width="50%">
      <el-form :model="memberInfo" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
