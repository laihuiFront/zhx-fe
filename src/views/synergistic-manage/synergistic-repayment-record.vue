  ...
  <div id="synergistic-repayment-record" class="page-wraper-sub"
   ...
   element-loading-background="rgba(0, 0, 0, 0.7)">
    ...
    <div class="statistics-wrap" v-if="queryForm.recordStatus==='0'">
      ...
      <el-table-column width="120"  sortable="custom" align="center" :sort-orders="['ascending','descending']" prop="dataCase.balanceMsg" label="还款余额" show-overflow-tooltip></el-table-column>
