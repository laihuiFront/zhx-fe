<template>
  <el-form id="letter-application-query" :model="queryForm" :inline="true" class="query-wrap">
    <el-form-item>
      ...
      <el-popover
        ...
        <ul class="condition-wrap">
          ...
          <li class="condition-item half">
            <el-input v-model="queryForm.gaxlh" type="number" clearable placeholder="委案金额下限"></el-input> 至
            <el-input v-model="queryForm.gaxlh" type="number" clearable placeholder="请委案金额上限"></el-input>
          </li>
          <li class="condition-item half">
            <el-date-picker
              clearable
          ...
          <li class="condition-item">
            <el-input v-model="queryForm.zjh" clearable placeholder="请输入申请人"></el-input>
          </li>
          <li class="condition-item">
