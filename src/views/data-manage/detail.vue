  ...
  >
    <div class="basic-info">
      <div class="title-info">
        ...
        <div style="text-align: right; margin-right:20px;">
          <el-button v-if="showNext" type="primary" class="btn" align="right" size="mini" @click="lastCase">上条</el-button>
          <el-button v-if="showNext" type="primary" class="btn" align="right" size="mini" @click="nextCase">下条</el-button>
          <el-button v-if="buttonAuth" type="primary" class="btn" align="right" size="mini" @click="showEdit">编辑</el-button>
          <el-button v-if="buttonAuth" type="primary" class="btn" align="right" size="mini" @click="showCommentVisible=true">评语</el-button>
          <el-button v-if="buttonAuth" type="primary" class="btn" align="right" size="mini" @click="showWarningVisible=true">警告</el-button>
          <el-button v-if="buttonAuth" type="primary" class="btn" align="right" size="mini" @click="showCollectInfo">催收小结</el-button>
        </div>
      </div>
        ...
        >
          ...
          <div class="form1">
            ...
            <div class="itemStyle">
              ...
              <el-input v-model="caseDetail.client" :disabled="true" class="fixwidth" />
            </div>
            <div class="itemStyle">
            ...
            <div class="itemStyle">
              ...
              <el-input v-model="caseDetail.cardNo" :disabled="true" class="fixwidth" />
            </div>
            ...
            <div class="itemStyle">
              ...
              <el-input v-model="caseDetail.moneyMsg" :disabled="true" class="fixwidth" />
            </div>
            <div class="itemStyle">
            ...
            <div class="itemStyle">
              ...
              <el-input v-model="caseDetail.odv" :disabled="true" class="fixwidth" />
            </div>

            <div class="itemStyle">
              <el-form-item label="已还款" class="lableStyle" />
              <div class="inputDiv fixwidth" style="font-size: 12px;">
                <span>{{ caseDetail.enRepayAmtMsg }}（委案余额:{{ caseDetail.balanceMsg }}）</span>
                <span
          ...
          >
            <div class="style1">
              <div class="itemStyle">
                ...
                <el-input v-model="caseDetail.identType" :disabled="true" class="fixwidth" />
              </div>
              <div class="itemStyle">
                <el-form-item label="合同编号" class="lableStyle" />
                <el-input v-model="caseDetail.contractNo" :disabled="true" class="fixwidth" />
              </div>
              <div class="itemStyle">
                <el-form-item label="人民币" class="lableStyle" />
                <el-input v-model="caseDetail.rmb" :disabled="true" class="fixwidth" />
              </div>
              <div class="itemStyle">
                <el-form-item label="港币" class="lableStyle" />
                <el-input v-model="caseDetail.hkd" :disabled="true" class="fixwidth" />
              </div>
              <div class="itemStyle">
              ...
              <div class="itemStyle">
                ...
                <el-input v-model="caseDetail.tel" :disabled="true" class="fixwidth" />
              </div>
              <div class="itemStyle">
              ...
              <div class="itemStyle">
                ...
                <el-input v-model="caseDetail.bank" :disabled="true" class="fixwidth" />
              </div>
              <div class="itemStyle">
              ...
              <div class="itemStyle">
                ...
                <el-input v-model="caseDetail.bail" :disabled="true" class="fixwidth" />
              ...
              <div class="itemStyle">
                ...
                <el-input v-model="caseDetail.age" :disabled="true" class="fixwidth" />
              </div>
              <div class="itemStyle">
                <el-form-item label="QQ" class="lableStyle" />
                <el-input v-model="caseDetail.qq" :disabled="true" class="fixwidth" />
              </div>
              <div class="itemStyle">
                <el-form-item label="邮箱" class="lableStyle" />
                <el-input v-model="caseDetail.email" :disabled="true" class="fixwidth" />
              </div>
              <div class="itemStyle">
              ...
              <div class="itemStyle">
                ...
                <el-input v-model="caseDetail.goods" :disabled="true" class="fixwidth" />
              </div>
              <div class="itemStyle">
        ...
        <div class="left-wrap">
          ...
          >
            ...
            <el-tab-pane label="地址" name="2" class="tabs-wrap telPanel">
              <div v-if="letterVisible2" class="operation">
                <div class="left-oper">
                  <el-button
                    v-if=" caseDetail.currentuser || mycaseFlag"
            ...
            >
              <div class="first">
                ...
                <el-table highlight-current-row border show-overflow-tooltip :data="memorizeList2">
                  <el-table-column
                    prop="repayAmtMsg"
                    show-overflow-tooltip
                    align="center"
            ...
            <el-tab-pane v-if="userInfo.sameBatch" label="共债案件" name="10" class="tabs-wrap telPanel">
              <el-table
                highlight-current-row
                :data="caseSameList"
                @row-dblclick="showCase"
        ...
        <div class="left-panel">
          ...
          >
            <div class="rowStyle">
              <div class="itemStyle2">
                <el-form-item label="电话" prop="mobile" class="lableStyle2_phone" :rules="{required: true, message: '电话不能为空', trigger: 'blur'}">
              ...
              <div class="itemStyle2">
                <el-form-item label="姓名" prop="targetName" class="lableStyle2" :rules="{required: true, message: '姓名不能为空', trigger: 'blur'}">
                  <el-input
              ...
              <div class="itemStyle2">
                <el-form-item label="关系" prop="relation" class="lableStyle2" :rules="{required: true, message: '关系不能为空', trigger: 'blur'}">
                  <el-input
          ...
          <div class="operation">
            <el-button
              type="primary"
              class="btn"
              @click="onClickSaveCollection('batchForm')"
            >保存</el-button>
            <el-button
              @click="batchForm = { sType: 0,targetName:'',mobile:'',relation:'',collectInfo:'' };$nextTick(()=>{
                if($refs['batchForm']) {
      ...
      >
        ...
        <el-form-item label="类型">
          <el-select
            ...
            clearable
          >
            <el-option key="1" label="单位地址" value="单位地址" />
            <el-option key="2" label="家庭地址" value="家庭地址" />
            <el-option
              key="3"
              label="对账单地址"
              value="对账单地址"
            />
            <el-option key="4" label="户籍地址" value="户籍地址" />
            <el-option key="5" label="其他地址" value="其他地址" />
          </el-select>
        </el-form-item>
        <el-form-item label="状态">
          <el-select
        ...
        <el-form-item label="备注" class="whole">
          <el-input v-model="addressInfo.remark" type="textarea" />
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
      ...
      >
        <el-form-item label="催收措施">
          <el-select
            ...
            clearable
          >
            <el-option :key="1" label="电话催收" value="电话催收" />
    ...
    >
      ...
      >
        ...
        <el-form-item label="期次">
          <el-input v-model="letterInfo.periods" :disabled="true" />
        </el-form-item>
    ...
    >
      ...
      >
        ...
        <el-form-item label="判决书" class="whole">
          <el-input v-model="legalForm.judgment" type="textarea" />
        </el-form-item>
        <el-form-item label="备  注" class="whole">
          <el-input v-model="legalForm.remark" type="textarea" />
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          type="primary"
          @click="saveSynergyResult('synergyInfo')"
        >确 定</el-button>
      </span>
    </el-dialog>
    ...
    >
      ...
      <el-table v-loading="telhistoryLoading" :data="telhistory">
        <el-table-column
    ...
    >
      ...
      >
        ...
        <el-form-item label="所在区域" class="whole address">
          <div>
            <el-select v-model="caseInfo.provinceName" placeholder="请选择省份" clearable @change="showCity()">
              <el-option
            ...
            <el-select v-model="caseInfo.cityName" placeholder="请选择市" clearable @change="showcounty()">
              <el-option
...
export default {
  ...
  methods: {
    ...
    queryExportCollectConfList() {
      const queryObj = { module: 'detail-exportCollect', menu: this.exportCollectConf }
    ...
    selectCollectModule() {
      const dicId = this.batchForm.module
    ...
    initPageData(ida) {
      const id = ida || this.$route.query.id || ''
